...
If you discover a security vulnerability in DPronix, please report it responsibly.
...
1. **GitHub Security Advisory** (preferred):
   - Go to the [Security Advisories](https://github.com/W117C/DPronix/security/advisories) page
...
DPronix implements defense-in-depth through multiple layers:
...
Administrators can disable capabilities via `[security] disabled_capabilities` in `dpronix.toml`.
